sap.ui.controller("emalDubalAR.view.detailAR", {
  ...
  loadDetail: function(oNameParam_instanceID) {
    ...
    var filters = new Array();
    var filterVal = new sap.ui.model.Filter("WiId", sap.ui.model.FilterOperator.EQ, oNameParam_instanceID);
    var filterVal1 = new sap.ui.model.Filter("SAP__Origin", sap.ui.model.FilterOperator.EQ, this.syst);
    filters.push(filterVal);
    filters.push(filterVal1);
    model.read("/ZAR_DATA2Set", { //new data set with description text
      filters: filters,
      success: function(oData, response) {
  ...
  loadWiLogDetail: function() {
    var model = this.getOwnerComponent().getModel("detailWiLogModele");
    //var model = this.getOwnerComponent().getModel("detailWiLogModeleNew");
    var localModel = this.getView().getModel("detailWiLogModelValue");
    var filters = new Array();
    var filterVal = new sap.ui.model.Filter("WiId", sap.ui.model.FilterOperator.EQ, this.oNameParam_instanceID); //'250762' value hard coded
    var filterVal1 = new sap.ui.model.Filter("SAP__Origin", sap.ui.model.FilterOperator.EQ, this.syst); //'250762' value hard coded

    filters.push(filterVal);
    filters.push(filterVal1);

    console.log(this.param);
    model.read("/ZWF_LOGSet", {
      filters: filters,
      success: function(oData, response) {
